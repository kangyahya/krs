...
class Dosen extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/dosen/table_dosen_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'alamat' => $row->alamat,
		'bidang_keahlian' => $row->spesial_mengajar,
		'jabatan' => $row->jabatan,
		'tlpn' => $row->telp,
		'status' => $row->status,
	    );
            $this->load->view('admin/dosen/table_dosen_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('administrator/dosen'));
        }
    }
    ...
    public function create() 
    {
        ...
        $data = array(
            'button' => 'Create',
            'action' => site_url('administrator/dosen/create_action'),
        ...
        $this->load->view('admin/dosen/table_dosen_form', $data);
    }
    ...
    public function create_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $data = array(
                ...
                'spesial_mengajar' => $this->input->post('bidang_keahlian',TRUE),
                'jabatan' => $this->input->post('jabatan',TRUE),
                'telp' => $this->input->post('tlpn',TRUE),
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('administrator/dosen/update_action'),
		...
		'bidang_keahlian' => set_value('bidang_keahlian', $row->spesial_mengajar),
		'jabatan' => set_value('jabatan', $row->jabatan),
		'tlpn' => set_value('tlpn', $row->telp),
	...
	foreach ($this->Modeldosen->get_all() as $data) {
	    ...
	    xlsWriteLabel($tablebody, $kolombody++, $data->spesialis_mengajar);
