...
class Mahasiswa extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/mahasiswa/table_mahasiswa_list', $data);
    }
    ...
    public function read($id)
    {
		...
		'photo' => $row->foto,
            ...
            $this->load->view('admin/mahasiswa/table_mahasiswa_read', $data);
        } else {
    ...
    public function create()
    {
        ...
        $this->load->view('admin/mahasiswa/table_mahasiswa_form', $data);
    }
    ...
    public function create_action()
    {
        ...
        if ($hasil['file_name']==''){
         $data = array('nim'=>$this->db->escape_str($this->input->post('nim', TRUE)),
            ...
            redirect(site_url('administrator/mahasiswa'));
        }
