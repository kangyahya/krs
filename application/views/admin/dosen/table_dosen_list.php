...
?>
 <div class="page-container">
        ...
        <div class="row" style="margin-bottom: 10px">
            <div class="col-md-6">
               <a href="<?php echo site_url('administrator/dosen/create'); ?>" class="btn btn-success"><i class=" icon-compose" ></i> Tambah data</a></li>
            </div>
            <div class="col-md-6 text-right">
                <form action="<?php echo site_url('administrator/dosen/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('administrator/dosen'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
        ...
        <div class="table-responsive">
			...
			<td><?php echo $dosen->spesial_mengajar ?></td>
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <a href="<?php echo site_url() ?>administrator/dosen/excel" class="btn btn-success"><i class=" icon-file-excel" ></i> Export ke Excel</a></li>
        </div>
            <div class="col-md-6 text-right">
                <?php echo $pagination ?>
            </div>
